...
persist_dir = "./agents/vectordb1"  # Use a different directory for tool2

if not os.path.exists(os.path.join(persist_dir, "default__vector_store.json")):
    print("Creating new index")
    filepath = './agents/file_2.txt'
...
tool2 = QueryEngineTool.from_defaults(query_engine, 
    name="Shyam",
    description="A RAG engine that tells about Shyam",
)
print("Tool2 Initialized:", tool2)
